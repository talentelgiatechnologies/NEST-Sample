...
@Entity('experience_old_booking')
export class ExperienceOldBookingEntity {
  @PrimaryGeneratedColumn('uuid')
  id: string;

  @OneToOne(() => ExperienceBookingEntity, (experienceBooking) => experienceBooking.oldBooking, { nullable: false })
